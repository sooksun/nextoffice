...
ตอบเป็น JSON เท่านั้น ตามโครงสร้างนี้:
{
  ...
  "structured_summary": {
    "sender": "ใคร/หน่วยงานใดส่งหนังสือมา (ชื่อหน่วยงานต้นสังกัด)",
    "request": "ขอให้ผู้รับทำอะไร/ดำเนินการอย่างไร — ถ้าไม่มีการร้องขอให้ระบุ 'เป็นหนังสือประชาสัมพันธ์ เพื่อแจ้งให้ครูทราบ'",
    "location": "ต้องไปที่ไหน/สถานที่ใด (ถ้าไม่มีให้ระบุ null)",
    "deadline": "กำหนดวันที่ต้องดำเนินการ/รายงาน ภายในวันที่เท่าไร (ถ้าไม่มีให้ระบุ null)",
