...
ตอบเป็น JSON เท่านั้น (ไม่ต้องมี markdown code fence):
{
  ...
  // ── Extraction ───────────────────────────────────────────────────────────
  {
    ...
    promptText: `คุณเป็นผู้ช่วยวิเคราะห์หนังสือราชการระดับผู้เชี่ยวชาญ — [v2-fieldfix]
...
ตอบเป็น JSON เท่านั้น ตามโครงสร้างนี้:
{
  ...
  "issuing_authority": "ชื่อ**หน่วยงาน**ที่ออกหนังสือ — ดูจาก (1) ชื่อองค์กร/ที่อยู่ที่พิมพ์ในส่วนหัวขวา เช่น 'สำนักงานเขตพื้นที่การศึกษาประถมศึกษาเชียงราย เขต ๓' (2) ชื่อย่อหน่วยงาน เช่น 'กสศ.' 'สพฐ.' หรือ (3) ตำแหน่งผู้ลงนามท้ายหนังสือ — ระบุเฉพาะ**ชื่อหน่วยงาน** ไม่ใช่ชื่อบุคคล",
  ...
  "document_no": "เลขที่หนังสือราชการ — คือรหัสเอกสารที่ขึ้นต้นด้วย 'ที่' ในส่วนหัว เช่น 'ศธ ๐๕๐๔๕/๑ ๔๗๓' หรือ 'กสศ.๐๖/๙๕๖๒' — ให้คงอักษรและตัวเลขไทยตามต้นฉบับ ห้ามนำตัวเลขจากวันที่หรือจาก 'เลขรับ/ทะเบียนรับ' ที่อยู่ในตราประทับของผู้รับมาใส่",
  "document_date": "วันที่ที่ระบุในหนังสือ (ไม่ใช่วันที่รับหนังสือ) — มักอยู่บรรทัดเดียวกับหรือใต้ที่อยู่หน่วยงานในส่วนหัว เช่น '๑๓ มีนาคม ๒๕๖๙' — format YYYY-MM-DD **ปี ค.ศ. เท่านั้น** (แปลง พ.ศ.→ค.ศ. โดยลบ 543 เช่น ๒๕๖๙-543=2026 → '2026-03-13')",
  ...
  "structured_summary": {
    "sender": "ชื่อหน่วยงานที่ออกหนังสือ — ต้องตรงกับ issuing_authority ที่วิเคราะห์ได้",
    "request": "สาระสำคัญที่ผู้ส่งแจ้ง/ขอ ใน 1-2 ประโยค — เช่น 'แจ้งโอนเงินอุดหนุนค่าปัจจัยพื้นฐาน จำนวน X บาท' หรือ 'ขอเชิญเข้าร่วมอบรม...' — ห้ามใส่เลขที่หนังสือ ที่อยู่ หรือ OCR text ดิบ",
